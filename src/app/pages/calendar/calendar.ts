...
export class CalendarPage {
  ...
  protected readonly days = computed(() => CalendarPage.buildDays(this.weekStart()));
  ...
  private static buildDays(lundi: Date): Day[] {
    const jourName = new Intl.DateTimeFormat('fr-FR', { weekday: 'short' });
    const jourNum = new Intl.DateTimeFormat('fr-FR', { day: 'numeric' });
